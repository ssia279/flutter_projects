...
import 'dart:math';
import 'package:simple_pong/views/ball.dart';
import 'package:simple_pong/views/bat.dart';
...
class _PongState extends State<Pong> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    posX = 0;
    posY = 0;
    controller = AnimationController(vsync: this, duration: const Duration(minutes: 10000));
